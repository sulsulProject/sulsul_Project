    ...
    <div class="container">
      ...
      <div class="row align-items-center mb-5">
        ...
        <div class="col-lg-4 count-box">
         <span class="count-text">위스키 <strong style="color: #c71585">${count }개</strong>의 상품</span>
        </div>
      </div>
      ...
      <div class="row rows">
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4" v-for="vo in whiskey_list">
              <div class="product-item">
                ...
                <div class="cate_label">
                 <span style="background: #F6EC9C">{{vo.nation}}</span>
                 <span style="background: #F6EC9C">{{vo.vintage}}</span>
                 <span style="background: #F6EC9C">{{vo.capacity}}</span>
                </div>
                <div class="price">
    ...
    <div class="untree_co-section bg-light">
      <div class="container">
       ...
       new Vue({
          ...
          mounted:function(){
             let _this=this
             axios.get('http://localhost/web/wine/whiskey_list_vue.do',{
                params:{
                   page:this.curpage,
                   ino:this.ino,
                   no:this.no
                ...
                _this.whiskey_list=response.data
          ...
          next:function(){
            ...
            this.no=no
             let _this=this;
             axios.get("http://localhost/web/wine/whiskey_hit_vue.do",{
                params:{
                   no:no,
                   page:this.curpage
                }
